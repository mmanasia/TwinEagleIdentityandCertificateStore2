...
class EnvironmentsControllerTest < ActionController::TestCase
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post :create, environment: { CreatedBy: @environment.CreatedBy, CreatedDate: @environment.CreatedDate, EnvironmentDescription: @environment.EnvironmentDescription, EnvironmentName: @environment.EnvironmentName, IsDeleted: @environment.IsDeleted, LastModifiedBy: @environment.LastModifiedBy, LastModifiedDate: @environment.LastModifiedDate }
    end
  ...
  test "should update environment" do
    patch :update, id: @environment, environment: { CreatedBy: @environment.CreatedBy, CreatedDate: @environment.CreatedDate, EnvironmentDescription: @environment.EnvironmentDescription, EnvironmentName: @environment.EnvironmentName, IsDeleted: @environment.IsDeleted, LastModifiedBy: @environment.LastModifiedBy, LastModifiedDate: @environment.LastModifiedDate }
    assert_redirected_to environment_path(assigns(:environment))
  end
