...
UserGroup.create(:id => 1, UserGroupName:'System User', admin: false )
UserGroup.create(:id => 2, UserGroupName: 'IT Support', admin: true)
UserGroup.create(:id => 3, UserGroupName:'System Manager', admin: true)
